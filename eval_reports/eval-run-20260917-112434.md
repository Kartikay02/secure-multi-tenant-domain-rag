# RAG Evaluation Report: eval-run-20260917-112434
...
## Executive Summary
- **Run ID**: `5b854637-c92e-4d3a-9a28-dac16a59a792`
- **Dataset**: `domain_rag_production_golden_benchmark` (v1.0.0)
- **Execution Period**: 2026-09-17T11:24:34.083096+00:00 to 2026-09-17T11:24:34.109169+00:00
- **Duration**: 0.03s
- **Total Samples**: 16
- **Success Count**: 16
...
| Metric | Value (ms) |
| :--- | :--- |
| **Mean Latency** | 1.28 ms |
| **Median / p50** | 0.49 ms |
| **p90 Latency** | 1.19 ms |
| **p95 Latency** | 3.86 ms |
| **p99 Latency** | 10.02 ms |
| **Min / Max** | 0.26 ms / 11.56 ms |

### Pipeline Stage Averages
| Stage | Mean Duration (ms) |
| :--- | :--- |
| `context_assembly_ms` | 0.74 ms |
| `generation_ms` | 0.18 ms |
| `preprocessing_ms` | 0.05 ms |
| `reranking_ms` | 0.00 ms |
| `retrieval_ms` | 0.18 ms |
| `total_ms` | 1.28 ms |
