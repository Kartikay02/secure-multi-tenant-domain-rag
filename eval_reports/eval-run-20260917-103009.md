# RAG Evaluation Report: eval-run-20260917-103009
...
## Executive Summary
- **Run ID**: `fbfd50b1-fb80-439a-8e85-e31adc8edc58`
- **Dataset**: `domain_rag_production_golden_benchmark` (v1.0.0)
- **Execution Period**: 2026-09-17T10:30:09.783870+00:00 to 2026-09-17T10:30:09.873075+00:00
- **Duration**: 0.09s
- **Total Samples**: 16
- **Success Count**: 16
...
| **Median / p50** | 1.45 ms |
| **p90 Latency** | 3.24 ms |
| **p95 Latency** | 15.63 ms |
| **p99 Latency** | 42.49 ms |
| **Min / Max** | 0.71 ms / 49.20 ms |

### Pipeline Stage Averages
| Stage | Mean Duration (ms) |
| :--- | :--- |
| `context_assembly_ms` | 2.82 ms |
| `generation_ms` | 0.80 ms |
| `preprocessing_ms` | 0.18 ms |
| `reranking_ms` | 0.00 ms |
| `retrieval_ms` | 0.36 ms |
| `total_ms` | 4.57 ms |
| `validation_ms` | 0.33 ms |
