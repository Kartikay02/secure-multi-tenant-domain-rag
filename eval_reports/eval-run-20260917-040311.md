# RAG Evaluation Report: eval-run-20260917-040311

## Executive Summary
- **Run ID**: `f8b0bdc2-a570-42c1-9ef0-49d3cee111cf`
- **Dataset**: `domain_rag_production_golden_benchmark` (v1.0.0)
- **Execution Period**: 2026-09-17T04:03:11.400204+00:00 to 2026-09-17T04:03:11.426906+00:00
- **Duration**: 0.03s
- **Total Samples**: 16
- **Success Count**: 16
...
| **Min / Max** | 0.22 ms / 11.86 ms |

### Pipeline Stage Averages
| Stage | Mean Duration (ms) |
| :--- | :--- |
| `context_assembly_ms` | 0.77 ms |
