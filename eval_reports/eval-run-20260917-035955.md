# RAG Evaluation Report: eval-run-20260917-035955

## Executive Summary
- **Run ID**: `6d01254d-9695-45c7-9882-f6fb3180d7c1`
- **Dataset**: `domain_rag_production_golden_benchmark` (v1.0.0)
- **Execution Period**: 2026-09-17T03:59:55.723554+00:00 to 2026-09-17T03:59:55.749911+00:00
- **Duration**: 0.03s
- **Total Samples**: 16
- **Success Count**: 16
...
| **p90 Latency** | 1.03 ms |
| **p95 Latency** | 3.82 ms |
| **p99 Latency** | 10.38 ms |
| **Min / Max** | 0.21 ms / 12.02 ms |

### Pipeline Stage Averages
| Stage | Mean Duration (ms) |
| :--- | :--- |
| `context_assembly_ms` | 0.78 ms |
| `generation_ms` | 0.17 ms |
| `preprocessing_ms` | 0.04 ms |
